...
namespace Kids_U_Database_Reporting.Data.Migrations
{
    ...
    [Migration("20200309202217_allSubjects")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kids_U_Database_Reporting.Models.LanguageArts", b =>
                {
                    b.Property<int>("LanguageArtsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("LanguageArtsId");

                    b.HasIndex("ReportCardId")
                        .IsUnique()
                        .HasFilter("[ReportCardId] IS NOT NULL");

                    b.ToTable("LanguageArts");
                });

            modelBuilder.Entity("Kids_U_Database_Reporting.Models.Math", b =>
                {
            ...
            modelBuilder.Entity("Kids_U_Database_Reporting.Models.Reading", b =>
                {
            ...
            modelBuilder.Entity("Kids_U_Database_Reporting.Models.LanguageArts", b =>
                {
                    b.HasOne("Kids_U_Database_Reporting.Models.ReportCard", "ReportCard")
                        .WithOne("LanguageArts")
                        .HasForeignKey("Kids_U_Database_Reporting.Models.LanguageArts", "ReportCardId");
                });
            ...
            modelBuilder.Entity("Kids_U_Database_Reporting.Models.Math", b =>
                {
                    b.HasOne("Kids_U_Database_Reporting.Models.ReportCard", "ReportCard")
                        .WithOne("Math")
                        .HasForeignKey("Kids_U_Database_Reporting.Models.Math", "ReportCardId");
                });
            ...
            modelBuilder.Entity("Kids_U_Database_Reporting.Models.Reading", b =>
                {
                    b.HasOne("Kids_U_Database_Reporting.Models.ReportCard", "ReportCard")
                        .WithOne("Reading")
                        .HasForeignKey("Kids_U_Database_Reporting.Models.Reading", "ReportCardId");
                });
